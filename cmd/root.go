...
func init() {
	...
	rootCmd.PersistentFlags().BoolVar(&GC.FollowCName, "iter-follow-cname", true, "When performing iterative mode queries for A records, enable tracking of CNAME record resolution.")
